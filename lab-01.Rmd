...
NA stands for not available, and represents the missing values in the data structure.I'm getting this, because some attractions do not have any values, meaning it is missing some values.
